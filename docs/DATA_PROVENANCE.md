...
├── ground_truth/
│   ├── quarterly_ground_truth_holdings.json # Audited SEC EDGAR Form N-30D / NPORT-P holdings (1995–2024, 35 verified quarters across 80 labeled periods)
...
- **SPDR S&P 500 ETF Trust (SPY)**: While SPY launched in January 1993, public historical portfolio snapshots prior to 2020 were filed only annually on Form N-30D (later Form N-CSR) at SPY's fiscal year-end. SPY's fiscal year ended December 31 through 1996 and September 30 from 1997 onward, so the 1995 and 1996 annual reports **are** December 31 primary sources, and every other pre-2020 annual filing is a September 30 snapshot. The year-end rosters remain unvalidated for 1994 and for 1997–2019 — but no longer for 1995 and 1996. SPY has never filed Form N-Q quarterly reports, leaving pre-2020 intermediate calendar quarter-ends (such as June 30) without quarterly regulatory filings in this filer. Separately, as a known gap rather than an absence on EDGAR, EDGAR also holds semi-annual Form N-30D filings at period 03-31 for 2010–2019 which this repository has not yet archived (tracked in #40), so claiming an absence of March 31 primary sources is also overstated. Quarterly point-in-time filings across all four calendar quarter-ends began only with Form NPORT-P XML in 2020. To provide verifiable ground truth without external dependencies, the repository archives 47 primary SEC EDGAR filings (20 NPORT-P XML, 26 historical annual reports, plus the newly archived SPY FY2004 N-30D) and parses them via a pure Python standard-library parser (§4.3.6) to establish 35 verified quarters (across 80 total labeled periods, up from 65 as unverified coverage now explicitly tracks historical year-ends) and quantify the historical survivorship gap.
...
- **Coverage Scope (1995–2024)**:
  ...
  - **Historical Annual Reports (1995–2019, 26 Filings + 1 FY2004 Replacement)**: Form `N-CSR` and `N-30D` filings containing the complete audited **Schedule of Investments**. **15 of these historical filings are extracted** (fiscal years 1995–2009: 1995 and 1996 are December 31 snapshots reflecting SPY's pre-1997 fiscal year-end, while 1997–2009 are September 30 snapshots). The remaining 10 annual reports (2010–2019) are HTML-era filings tracked under issue #40.
  ...
  - **Verified Quarters & Coverage Accounting**: Verified quarters stand at **35** (20 modern NPORT-P quarters + 15 historical Form N-30D filings: 2 December 31 snapshots for 1995–1996 and 13 September 30 snapshots for 1997–2009). The dataset labels **45 unverified historical periods** (bringing the tracked total from 65 to 80 periods: 35 verified, 45 unverified). The unverified count grew from 30 to 45 because coverage now explicitly includes the 13 unverified Q4 year-ends for 1997–2009 and 2 unverified Q3 periods for 1995–1996 rather than omitting them from the file. Historical Q1/Q2 calendar quarters (plus 1994) also lack regulatory filings in this filer and are labeled `[UNVERIFIED - No Filing]`.
...
- **Reconciliation Accuracy**:
  - Across all **35 verified regulatory filing quarters** (20 XML + 15 N-30D Annual Reports), average Top 10 match accuracy is **91.1%** (319/350).
  - Across the **15 historical Form N-30D quarters (1995–2009)**, accuracy is **83.3%** (125/150). The change comes from 1995 alone: against the Q4 candidate pool it scores 7/10 where it scored 8/10 against Q3, while 1996 scores 8/10 either way.
