...
- **Coverage is 1994–2006 except 2004, and the gap is named.** Twelve of the thirteen archived filings reconcile. The FY2004 HTML filing drops a position whose name and share cells render empty, leaving an orphaned value of \$24,416 thousand against a \$106B total; the year is recorded in `unreconciled_years` and not published.
